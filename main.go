...
import (
	...
	day_10 "github.com/cdsre/advent-of-code-2025/day-10"
	day_11 "github.com/cdsre/advent-of-code-2025/day-11"
	...
	"github.com/cdsre/advent-of-code-2025/day-9"
...
func main() {
	...
	case "D8P2":
		...
		fmt.Printf("%d\n", result)
	case "D9P1":
		data := helpers.LoadData("day-9/puzzle_data.txt")
		result := day_9.Puzzle1(data)
		fmt.Printf("%d\n", result)
	case "D9P2":
		data := helpers.LoadData("day-9/puzzle_data.txt")
		result := day_9.Puzzle2(data)
		fmt.Printf("%d\n", result)
	case "D10P1":
	...
	case "D10P2":
		...
		fmt.Printf("%d\n", result)
	case "D11P1":
		data := helpers.LoadData("day-11/puzzle_data.txt")
		result := day_11.Puzzle1(data)
		fmt.Printf("%d\n", result)
	case "D11P2":
		data := helpers.LoadData("day-11/puzzle_data.txt")
		result := day_11.Puzzle2(data)
		fmt.Printf("%d\n", result)
	}
